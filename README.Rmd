...
in the balanced $q$-dimenstional half-sib design
\[
  y_{ijk}
  = \mu + \alpha_i + \beta_{ij} + \epsilon_{ijk},
  \quad
  1\leq i \leq I,
  1\leq j \leq J,
  1\leq k \leq K.
...
where 
\[
  \alpha_i \sim \mathcal{N}(0, A),
  \quad
  \beta_{ij} \sim \mathcal{N}(0, B).
  \quad
  \epsilon_{ijk} \sim \mathcal{N}(0, E).
\]
